<template>
    <div>
        ...
        <hr>
        <div class="summary">
            <q-card inline class="bigger q-ma-sm" v-for="(item, index) in resultData" :key="item, index">
                    ...
                    <q-btn round flat icon="more_vert" slot="right">
                        <q-popover>
                            ...
                            <q-item v-close-overlay>
                                <q-item-main label=""> <router-link :to="{name:'courseplaner', params:{item,selectedstage}}">Download</router-link></q-item-main>
                            </q-item>
                            <q-item v-close-overlay>
