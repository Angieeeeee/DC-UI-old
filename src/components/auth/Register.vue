<template>
  <q-page class="card-postion">
    <div class="row card" style="margin:100px">
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 sign-up">
        ...
        <div style="margin-top:30px">
          <q-field :error="$v.email.$error" error-label="Please type a valid email">
            <q-input
              color="deep-purple-9"
              v-model="email"
              type="email"
          ...
          <q-field :error="$v.password.$error" error-label="Please type a valid password">
            <q-input
              id="password"
              color="deep-purple-9"
              v-model="password"
          ...
          <q-field :error="$v.cpassword.$error" error-label="Dosen't match">
            <q-input
              color="deep-purple-9"
              v-model="cpassword"
              type="password"
